        ...
        <div className="container mx-auto py-12 md:py-16">
          <div className="max-w-6xl mx-auto border-t border-b border-slate-100">
            <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
              <li className="flex flex-col md:flex-row items-start gap-4 p-6 md:p-8 border-b md:border-b-0 md:border-r border-slate-100">
              ...
              <li className="flex flex-col md:flex-row items-start gap-4 p-6 md:p-8 border-b md:border-b-0 md:border-r-0 border-slate-100">
                <div className="flex-shrink-0 inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#e6f7fb] text-[#2caee4]">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
